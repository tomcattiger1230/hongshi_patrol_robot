"""Transport interfaces and UDP JSON debug transport.

Replace this module's concrete transport with a DDS implementation when the
final DDS stack is selected. The onboard and remote application code should
continue depending on the small interfaces below.
"""
