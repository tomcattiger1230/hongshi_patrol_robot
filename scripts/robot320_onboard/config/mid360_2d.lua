...
options = {
  ...
  -- ============================================================
  -- 关键配置: Cartographer 发布 map→odom
  -- ============================================================
  map_frame = "map",
  tracking_frame = "base_link",
  published_frame = "odom",              -- 发布 map→odom
  odom_frame = "odom",
  provide_odom_frame = false,            -- 关键! 禁用自变换, 避免 odom→odom 冲突

  publish_frame_projected_to_2d = true,
  publish_tracked_pose = true,           -- 发布 /tracked_pose 供 EKF 使用
